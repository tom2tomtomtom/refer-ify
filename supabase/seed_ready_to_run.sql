-- =============================================
-- FOUNDING CIRCLE SEED DATA - READY TO RUN
-- User ID: 34c467cd-1bca-400c-bcd6-769481b06afe (thyde_uk@icloud.com)
-- =============================================
...
SELECT 'Founding Metrics' as table_name, count(*) as records FROM public.founding_metrics WHERE user_id = '34c467cd-1bca-400c-bcd6-769481b06afe'
UNION ALL
SELECT 'Advisory Sessions' as table_name, count(*) as records FROM public.advisory_sessions WHERE founder_id = '34c467cd-1bca-400c-bcd6-769481b06afe'  
UNION ALL
SELECT 'Invitations' as table_name, count(*) as records FROM public.select_circle_invitations WHERE founder_id = '34c467cd-1bca-400c-bcd6-769481b06afe'
UNION ALL
SELECT 'Network Activity' as table_name, count(*) as records FROM public.network_activity WHERE member_id = '34c467cd-1bca-400c-bcd6-769481b06afe';
