              ...
              <CardContent className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Manage your own network of 40+ Referrers</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-1 flex-shrink-0" />
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card>
              ...
              <CardContent>
                ...
                <div className="text-sm text-blue-600 font-medium">Referrer</div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="text-sm text-amber-600 font-medium">Founder</div>
              </CardContent>
            </Card>
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <select className="w-full border rounded-md p-2">
                    ...
                    <option value="select">Referrer (40% fees from referrals)</option>
                    <option value="founding">Founder (15% revenue share - invitation only)</option>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600">Referrers earn 40% of placement fees (typically $15,000-$25,000 per successful hire). Founders earn 15% of all revenue generated by their network, which can scale significantly.</p>
            </div>
